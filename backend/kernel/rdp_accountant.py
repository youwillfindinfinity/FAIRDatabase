"""
rdp_accountant.py — RDP (Rényi Differential Privacy) accountant.

Kernel DP-accounting primitive (was src/federated/fl_privacy.py; relocated in
migration plan Phase 5). Re-exported via ``kernel.privacy``.
